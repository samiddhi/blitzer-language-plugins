...
sys.path.insert(0, str(Path(__file__).parent.parent / "blitzer-language-pli"))

class TestPliPluginDownload(unittest.TestCase):
    ...
    def test_db_download_mechanism(self):
        ...
        with patch('pathlib.Path.exists', return_value=False), \
             patch('blitzer_language_pli.requests.get') as mock_get:
